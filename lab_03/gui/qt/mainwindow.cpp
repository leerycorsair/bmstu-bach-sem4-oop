...
void MainWindow::resetCamera() { this->ui->curr_camera_lbl->setText("Нет"); }

void MainWindow::resetModel() { this->ui->curr_model_lbl->setText("Нет"); }

bool MainWindow::cameraSelected() { return this->ui->curr_camera_lbl->text() != QString("Нет"); }

bool MainWindow::modelSelected() { return this->ui->curr_model_lbl->text() != QString("Нет"); }
